...
export class ProcessFlowStatusDetailsModel {
    ...
    private _statusDetails: any[] = [
        ...
        {statusId: 50, statusName: 'RCA',viewRoute: '#'+ROUTE_PATHS.RouteViewDetailsRCADI, editRoute: '#'+ROUTE_PATHS.RouteAddRCADI},
        {statusId: 60, statusName: 'CA', viewRoute: '#'+ROUTE_PATHS.RouteViewDetailsCADI, editRoute: '#'+ROUTE_PATHS.RouteAddCADI},
        {statusId: 70, statusName: 'PA', viewRoute: '#'+ROUTE_PATHS.RouteViewDetailsPADI, editRoute: '#'+ROUTE_PATHS.RouteAddPADI},
