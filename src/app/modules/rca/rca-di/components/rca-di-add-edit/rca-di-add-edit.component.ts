...
@Component({
  ...
  private updateBusySpinner() {
   ...
   public onRCADIAddEditSubmit() {
    console.log("form value of rca DI add/modify submit : ", this.rcaDIAddEditFormGroup.value);
    let rcaDIAddEditSubmitDet: any = {};
    rcaDIAddEditSubmitDet.complaintReferenceNo = "DI000010";//this.complaintReferenceNo;
    rcaDIAddEditSubmitDet.rootCauseAnanysisRemarks = this.rcaDIAddEditFormGroup.value.rcaAddEditDetails;//actn det
    rcaDIAddEditSubmitDet.plantType = "DI";
    rcaDIAddEditSubmitDet.rootCauseAnanysisDate = this.rcaAddEditDate;
    ...
    if (this.totalFileSize > this.fileSizeLimit) {
      ...
      this.rCADIService.rcaDIAddEditSubmitWithFileUpload(formDataObj).
        subscribe(res => {
