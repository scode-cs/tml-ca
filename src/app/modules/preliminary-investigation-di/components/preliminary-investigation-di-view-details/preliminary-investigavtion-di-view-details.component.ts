...
@Component({
  selector: 'ispl-preliminary-investigation-di-view-details-form',
  templateUrl: 'preliminary-investigavtion-di-view-details.component.html',
  // templateUrl: 'test.html',
  styleUrls: ['preliminary-investigavtion-di-view-details.component.css']
})
export class PreliminaryInvestigationDiViewDetailsComponent implements OnInit {
