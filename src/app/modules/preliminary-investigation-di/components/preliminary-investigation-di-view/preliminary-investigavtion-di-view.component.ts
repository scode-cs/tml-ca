...
@Component({
  selector: 'ispl-preliminary-investigation-di-view',
  templateUrl: 'preliminary-investigavtion-di-view.component.html',
  styleUrls: ['preliminary-investigavtion-di-view.component.css']
})
export class PreliminaryInvestigationReportDIViewComponent implements OnInit {
  ...
  constructor(
    ...
    private preliminaryInvestigationReportDIDataService: PreliminaryInvestigationReportDIDataService,
  ...
  getPreliInvestigationReportDIViewDetValues(prelijson: any) {
    ...
    this.preliminaryInvestigationReportDIDataService.getPreliminaryInvestigationReportDIViewDetails(this.sortSelection).
      subscribe(res => {
  ...
  editComplaint(){    
    ...
    console.log("preli investigation report for modify : ",this.modifyPreliInvReport);        
     // Not authenticated
    // this.router.navigate([ROUTE_PATHS.RouteModifyPreliminaryInvestigationDi,this.modifyPreliInvReport]);
  }//end of add preli method
  ...
  viewComplaint(){
    ...
    console.log("preli investigation report for view details : ",this.viewEditParam,this.modifyPreliInvReport);
     ...
     // Not authenticated
    // this.router.navigate([ROUTE_PATHS.RouterViewDetailsPreliminaryInvestigationDi,this.viewEditParam,this.modifyPreliInvReport]);
